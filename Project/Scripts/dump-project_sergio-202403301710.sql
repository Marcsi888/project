...
CREATE TABLE `apartment` (
  ...
  `exterior_or_interior` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `supervision` (
  `employee_id` int NOT NULL AUTO_INCREMENT,
  `building_id` char(4) DEFAULT NULL,
  `morning_or_afternoon` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`employee_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-03-30 17:10:52
